...
function Register() {
  ...
  return (
    ...
    <form className='w-auto flex flex-col m-4 justify-center'>
      ...
      <input className='w-64 my-2 text-gray-400 py-2 px-4 rounded-full bg-white border' placeholder='Confirma tu contraseña:' type="password" id="password" name="password"/><br/><br/>
      <input className='my-5 text-white  py-2 px-4 rounded-full bg-cyan-700 mx-auto hover:bg-cyan-400 hover:cursor-pointer' type="submit" value="Registrarse"/><br/><br/>
    </form>
